...
export default class Key {
    constructor(keyName, xOffset){ //assigning two parameters to the constructor 
        ...
        let material = new THREE.MeshNormalMaterial(); //creating the material to colour the object
        ...
        this.keyGroup.add(this.mesh); //transforming the mesh into a child of the keyGroup
    }
    getKeyGroup() {
